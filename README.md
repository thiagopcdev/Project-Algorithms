...
Nesse projeto, treinei a minha capacidade de resolução de problemas e otimização de código, que envolve algumas habilidades:
...
1. Clone the repository
  * `git clone git@github.com:thiagopcdev/Project-Algorithms.git`
2. Enter the repository folder you just cloned:
  * `cd SD-012-PROJECT-ALGORITHMS`
